...
public class CashierMainMenu {
    ...
    private void selectMerchandise() {
        ...
        switch (choice) {
            ...
            case 2 -> selectBags();
            case 3 -> selectMugs();
            case 4 -> selectOtherMerchandiseItem();
        }
    }
    ...
    private void selectOtherFoodItem(){

    }

    private void selectOtherDrinkItem() {
//        System.out.println("Select item under 'Others' category:");
//        // Assuming you have a method to retrieve items categorized as "Others"
//        List<Item> otherDrinks = getItemsByCategory("Others");
//
//        // If there are no items, inform the cashier
//        if (otherDrinks.isEmpty()) {
//            System.out.println("No items available under 'Others'.");
//            return;
//        }
//
//        // Display the items under 'Others'
//        for (int i = 0; i < otherDrinks.size(); i++) {
//            Item item = otherDrinks.get(i);
//            System.out.println("(" + (i + 1) + ") " + item.getName() + " - " + item.getPrice());
//        }
//
//        System.out.println("Select an item by number:");
//        int itemChoice = getValidInput(1, otherDrinks.size());
//
//        // Proceed to process the selected item
//        Item selectedItem = otherDrinks.get(itemChoice - 1);
//        processSelectedItem(selectedItem); // A method that processes the selected item, e.g., add to cart
    }

//    private void processSelectedItem(Item selectedItem) {
//        // Implement logic to process the selected item, e.g., add to cart
//        System.out.println("You selected: " + selectedItem.getName() + " for " + selectedItem.getPrice());
//        // Further logic for checkout, cart, etc.
//    }

    private void selectOtherMerchandiseItem(){
